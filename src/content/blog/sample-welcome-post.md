...
This is a placeholder post showing the expected frontmatter fields for each
blog entry. Delete this file once real posts are added, or set `draft: false`
on real posts (this one is left as `draft: true` so it won't appear on the
live site).
